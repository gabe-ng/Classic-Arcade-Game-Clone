...
var Engine = (function(global) {
  ...
  function updateEntities(dt) {
    ...
    capturedFriends.forEach(function(friend) {
      friend.update();
    });

    freedFriends.forEach(function(friend) {
      friend.update();
    });
  }
  ...
  function render() {
     ...
     */
    var rowImages = [
        'images/dirt-block.png', // Row of sand
        'images/dirt-block.png', // Row of sand
        ...
        'images/water-block.png', // Row of water
        'images/water-block.png', // Row of water
        'images/stone-block.png' // Row of sand
      ],
      numRows = 8,
      numCols = 7,
      row, col;
